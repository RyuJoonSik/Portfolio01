  ...
  var t = {
      ...
      8457: function (t, n, r) {
        ...
        t.exports = function (t) {
          ...
          if (
            ...
            for (r = new v((n = c(h.length))); n > E; E++)
              (d = m ? y(h[E], E) : h[E]), u(r, E, d);
          else
            for (
          ...
          if (
            (R &&
              ...
              h !== Object.prototype &&
                ...
                (l ||
                  i(w) === h ||
                  (a ? a(w, h) : "function" != typeof w[g] && u(w, g, E)),
                c(w, L, !0, !0),
                l && (p[L] = E))),
            d == m &&
              C &&
          ...
          if (b) f = t;
            ...
            if (o(l)) {
              for (p = 0, d = i(t.length); d > p; p++)
                if ((h = w(t[p])) && h instanceof s) return h;
              return new s(!1);
            }
            f = l.call(t);
          }
      ...
      6048: function (t, n, r) {
        ...
        t.exports = e
          ...
          : function (t, n) {
              i(t);
              for (var r, e = a(n), c = e.length, u = 0; c > u; )
                o.f(t, (r = e[u++]), n[r]);
              return t;
            };
      },
      ...
      1320: function (t, n, r) {
        ...
        (t.exports = function (t, n, r, c) {
          ...
          "function" == typeof r &&
            ...
            (u = f(r)).source ||
              (u.source = l.join("string" == typeof n ? n : ""))),
            t !== e
              ? (s ? !d && t[n] && (p = !0) : delete t[n],
                p ? (t[n] = r) : o(t, n, r))
              : p
              ? (t[n] = r)
              : a(n, r);
          ...
          { target: "Array", proto: !0, forced: !l },
          {
            slice: function (t, n) {
              ...
              if (
                ...
                return d.call(l, g, y);
              for (
                e = new (void 0 === r ? Array : r)(h(y - g, 0)), f = 0;
                g < y;
                g++, f++
              )
                g in l && s(e, f, l[g]);
            ...
            splice: function (t, n) {
              ...
              if (
                (0 === T
                  ...
                  : 1 === T
                  ? ((r = 0), (e = b - E))
                  : ((r = T - 2), (e = p(l(i(n), 0), b - E))),
                b + r - e > d)
              )
                throw TypeError(h);
              for (f = u(m, e), v = 0; v < e; v++)
                (g = E + v) in m && s(f, v, m[g]);
              if (((f.length = e), r < e)) {
                for (v = E; v < b - e; v++)
                  (y = v + r), (g = v + e) in m ? (m[y] = m[g]) : delete m[y];
                for (v = b; v > b - e + r; v--) delete m[v - 1];
              } else if (r > e)
                for (v = b - e; v > E; v--)
                  (y = v + r - 1),
                    (g = v + e - 1) in m ? (m[y] = m[g]) : delete m[y];
      ...
      8674: function (t, n, r) {
        ...
        var e,
          ...
          Q = A(D, function () {
            ...
            return (
              ((r.constructor = {})[M] = e),
              !($ = r.then(function () {}) instanceof e) || (!n && j && !J)
            );
          }),
          tt =
            Q ||
          ...
          et = function (t, n, r) {
            var e, o;
            Z
              ? (((e = H.createEvent("Event")).promise = n),
                (e.reason = r),
                e.initEvent(t, !1, !0),
                s.dispatchEvent(e))
              ...
              !J && (o = s["on" + t])
                ? o(e)
                : t === K && L("Unhandled promise rejection", r);
          },
          ot = function (t) {
            S.call(s, function () {
              var n,
      ...
      2526: function (t, n, r) {
        ...
        var e = r(2109),
          ...
          it = function (t, n) {
            ...
            return (
              B(r, { type: F, tag: t, description: n }),
              c || (r.description = n),
              r
            );
          },
          ...
          st = function (t) {
            ...
            return (
              !(this === X && l(K, n) && !l($, n)) &&
              (!(r || !l(this, n) || !l(K, n) || (l(this, G) && this[G][n])) ||
                r)
            );
          },
          ft = function (t, n) {
        ...
        u ||
          (I(
            (H = function () {
              ...
              return (
                c && et && ot(X, n, { configurable: !0, set: r }), it(n, t)
              );
            }).prototype,
            "toString",
            function () {
              ...
              (i._invoke = (function (t, n, r) {
                ...
                return function (o, i) {
                  ...
                  for (r.method = o, r.arg = i; ; ) {
                    ...
                    "throw" === u.type &&
                      ((e = h), (r.method = "throw"), (r.arg = u.arg));
                  }
                };
              })(t, r, a)),
              i
  ...
  (r.n = function (t) {
    ...
    (function () {
      ...
      var y = function (t) {
          var n = !0;
          return (
            "string" != typeof t && ((n = !1), console.log("is not String.")), n
          );
        },
        m = function (t) {
          var n = !0;
          return (
            "number" != typeof t && ((n = !1), console.log("is not Number.")), n
          );
        },
        b = {
          ...
          drawRoulette: function () {
            this.rouletteIsEmpty()
              ? this.erase()
              : (this.drawCircle(), this.drawArrow(), this.drawText());
          },
          easingOut: function (t, n, r, e) {
            if (m(t) && m(n) && m(r) && m(e))
              return (t /= e), r * (--t * t * t + 1) + n;
          },
      ...
      var x = {
        ...
        clearContent: function () {
          var t = this.DESCRIPTION,
            n = this.LIST;
          t.classList.add("dialog__desc--isInvisible"),
            n.classList.add("dialog-list--isInvisible");
        },
        Equip: function () {
          var t = this.MODELESS_DIALOG,
            n = this.PARENT,
            r = this.CONTENT,
            e = document.getElementById("btnRouletteStart");
          n.insertBefore(t, e), r.focus();
        },
        alert: function (t, n) {
          if (y(t) && y(n)) {
            this.clearContent();
        ...
        setList: function (t) {
          if (
            ((T = !0),
            "object" != typeof t && ((T = !1), console.log("is not Object.")),
            T)
          ) {
            var n = this.LIST,
            ...
            t)) {
              ...
              try {
                for (h.s(); !(p = h.n()).done; ) {
                  var v = p.value,
                    g = e.cloneNode(!0);
                  g.classList.add("dialog-list__name--sub"),
                    (g.textContent = v);
                  var y = c.cloneNode(!0);
                  g.appendChild(y);
                  var m = o.cloneNode(!0);
        ...
        handleList: function (t) {
          if ("BUTTON" === t.target.nodeName || "SPAN" === t.target.nodeName) {
            ...
            if (n.nextSibling)
              ...
              var e = r.textContent;
              r.classList.contains("dialog-list__name--sub-isClicked")
                ? b.addDistrict(e)
                : b.removeDistrict(e);
            }
          }
        ...
        set: function () {
          ...
          var t = this.TITLE,
            n = this.LIST;
          (t.textContent = "지역 설정"),
            n.classList.remove("dialog-list--isInvisible"),
            this.Equip();
        },
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        (t.prev = 0), (t.next = 3), fetch("./district.json")
                      );
                    case 3:
                      if ((n = t.sent).ok) {
                        t.next = 6;

      ...
      8457: function (t, n, r) {
        ...
        t.exports = function (t) {
          var n,
            ...
            b = s(h),
            E = 0;
          if ((m && (g = e(g, y > 2 ? arguments[2] : void 0, 2)), null == b || (v == Array && a(b))))
            for (r = new v((n = c(h.length))); n > E; E++) (d = m ? g(h[E], E) : h[E]), u(r, E, d);
          else
            for (p = (l = b.call(h)).next, r = new v(); !(f = p.call(l)).done; E++)
              (d = m ? i(l, g, [f.value, E], !0) : f.value), u(r, E, d);
          return (r.length = E), r;
        };
      },
      1318: function (t, n, r) {
      ...
      2109: function (t, n, r) {
        ...
        t.exports = function (t, n) {
          var r,
            ...
            v = t.global,
            y = t.stat;
          if ((r = v ? e : y ? e[h] || c(h, {}) : (e[h] || {}).prototype))
            for (f in n) {
              if (
                ((p = n[f]),
      ...
      9909: function (t, n, r) {
        ...
        if (a || l.state) {
          ...
          (e = function (t, n) {
            ...
            return (n.facade = t), b.call(y, t, n), n;
          }),
            (o = function (t) {
              return g.call(y, t) || {};
            }),
      ...
      5948: function (t, n, r) {
        ...
        S ||
          ...
          h || y || v || !g || !m
            ...
            : ((c = !0),
              (u = m.createTextNode('')),
              new g(e).observe(u, { characterData: !0 }),
              (a = function () {
                u.data = c = !c;
              }))),
          (t.exports =
          ...
          { target: 'Array', proto: !0, forced: !l },
          {
            slice: function (t, n) {
              ...
              if (
                ...
                return d.call(l, y, g);
              for (e = new (void 0 === r ? Array : r)(h(g - y, 0)), f = 0; y < g; y++, f++) y in l && s(e, f, l[y]);
              return (e.length = f), e;
            },
          }
        );
          ...
          { target: 'Array', proto: !0, forced: !f },
          {
            splice: function (t, n) {
              ...
              if (
                ...
                throw TypeError(h);
              for (f = u(m, e), v = 0; v < e; v++) (y = E + v) in m && s(f, v, m[y]);
              if (((f.length = e), r < e)) {
                for (v = E; v < b - e; v++) (g = v + r), (y = v + e) in m ? (m[g] = m[y]) : delete m[g];
                for (v = b; v > b - e + r; v--) delete m[v - 1];
              } else if (r > e)
                for (v = b - e; v > E; v--) (g = v + r - 1), (y = v + e - 1) in m ? (m[g] = m[y]) : delete m[g];
          ...
          ot = function (t) {
            w.call(s, function () {
              ...
              if (
                it(t) &&
                ((n = N(function () {
                  P ? Y.emit('unhandledRejection', e, r) : et(K, r, e);
                })),
        ...
        if (
          ...
          (a = B.then),
            $ ||
              ...
              p(B, 'catch', V.catch, { unsafe: !0 }));
          try {
            delete B.constructor;
          } catch (t) {}
          h && h(B, V);
        }
        c({ global: !0, wrap: !0, forced: Q }, { Promise: z }),
          v(z, D, !1, !0),
          y(D),
          (i = f(D)),
          c(
        ...
        var e = r(2109),
          ...
          ot =
            ...
            f(function () {
              ...
              ? function (t, n, r) {
                  var e = q(X, n);
                  e && delete X[n], Z(t, n, r), e && t !== X && Z(X, n, e);
                }
              : Z,
          it = function (t, n) {
            var r = (K[t] = b(H.prototype));
            return z(r, { type: F, tag: t, description: n }), c || (r.description = n), r;
          },
          at = s
            ? function (t) {
      ...
      var g = function (t) {
        ...
        b = {
          ...
          addDistrict: function (t) {
            g(t) && (this.ROULETTE.DISTRICTS.push(t), this.drawRoulette());
          },
      ...
      var S = {
        ...
        Equip: function () {
          var t = this.MODELESS_DIALOG,
            n = document.getElementById('wrap');
          document.body.insertBefore(t, n.nextSibling);
        },
        alert: function (t, n) {
          if (g(t) && g(n)) {
            this.clearContent();
        ...
        setList: function (t) {
          if (((T = !0), 'object' != typeof t && ((T = !1), console.log('is not Object.')), T)) {
            ...
            (o.className = 'dialog-list__btn'), (o.tabIndex = '2');
            ...
            t)) {
              ...
              try {
                for (h.s(); !(p = h.n()).done; ) {
                  var v = p.value,
                    y = e.cloneNode(!0);
                  y.classList.add('dialog-list__name--sub'), (y.textContent = v);
                  var g = c.cloneNode(!0);
                  y.appendChild(g);
                  var m = o.cloneNode(!0);
                  m.appendChild(y);
